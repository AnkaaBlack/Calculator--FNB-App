...
const percent = document.querySelector(".percent"); // Add this line if you have a % button with class "percent"

if (percent) {
    percent.addEventListener("click", () => {
        // Convert the current display value to percentage
        numberDisplay.value = parseFloat(numberDisplay.value) / 100;
        isNumberDisplayEmpty = false;
    });
}
